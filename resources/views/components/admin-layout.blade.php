...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-name { font-size: 14px; font-weight: 700; color: var(--text-primary); letter-spacing: -0.3px; }
        ...
        .nav-item.active { background: var(--accent-soft); color: var(--badge-accent-text); border-color: rgba(184,255,0,0.2); }
        ...
        .nav-item.active .nav-icon { background: var(--accent-soft); color: var(--badge-accent-text); }

        .nav-badge {
            margin-left: auto; font-size: 10px; font-weight: 700;
            padding: 2px 7px; border-radius: 20px;
            background: var(--accent-soft); color: var(--badge-accent-text);
        }
        ...
        .user-avatar {
            ...
            display: flex; align-items: center; justify-content: center;
            font-size: 13px; font-weight: 700; color: var(--accent-text); flex-shrink: 0;
        }
        ...
        .logout-btn:hover { background: var(--rose-soft); color: var(--rose); border-color: rgba(244,63,94,0.25); }
        ...
        .form-input:focus, .form-textarea:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(184,255,0,0.15); }
