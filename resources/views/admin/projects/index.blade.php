    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">Click the status badge to toggle active/inactive</div>
            </div>
        </div>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'JetBrains Mono',monospace; font-weight:700; color:var(--text-primary); font-size:13px;">{{ $project->number }}</span>
                        </td>
                        <td>
                        ...
                        <td style="text-align:right">
                            <div style="display:inline-flex; gap:6px; align-items:center;">
                                ...
                                <form action="{{ route('admin.projects.destroy', $project->id) }}" method="POST" onsubmit="return confirm('Delete \'{{ $project->title }}\'? This cannot be undone.')">
                                    @csrf @method('DELETE')
