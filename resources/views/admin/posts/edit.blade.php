        ...
        <form method="POST" action="{{ route('admin.posts.update', $post) }}" enctype="multipart/form-data">
            ...
            <div style="display:flex; flex-direction:column; gap:18px;">
                ...
                <div>
                    ...
                    <textarea name="content" id="postContent" rows="14" required style="display:none; width:100%; padding:12px 14px; background:var(--bg-elevated); border:1px solid var(--border); border-radius:10px; color:var(--text-primary); font-size:13.5px; font-family:'JetBrains Mono', monospace; line-height:1.6;">{{ old('content', $post->content) }}</textarea>
