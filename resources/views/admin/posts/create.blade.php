            ...
            <div style="display:grid; grid-template-columns: 2fr 1fr; gap:24px;">
                ...
                <div style="display:flex; flex-direction:column; gap:18px;">
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="14" required placeholder="Tuliskan konten artikel Anda di sini..." style="width:100%; padding:12px 14px; background:var(--bg-elevated); border:1px solid var(--border); border-radius:10px; color:var(--text-primary); font-size:14px; font-family:'Inter', sans-serif; line-height:1.6;">{{ old('content') }}</textarea>
                ...
                <div style="display:flex; flex-direction:column; gap:18px; background:var(--bg-surface); padding:20px; border-radius:16px; border:1px solid var(--border);">
                    ...
                    <div style="border-top:1px solid var(--border); padding-top:16px; margin-top:8px;">
                        ...
                        <div style="margin-bottom:12px;">
                            ...
                            <input type="text" name="meta_title" value="{{ old('meta_title') }}" placeholder="Judul untuk Google Search" style="width:100%; padding:8px 12px; background:var(--bg-elevated); border:1px solid var(--border); border-radius:8px; color:var(--text-primary); font-size:12.5px;">
                        </div>

                        <div>
                            <label style="display:block; font-size:11px; color:var(--text-secondary); margin-bottom:4px;">Meta Keywords</label>
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="laravel, php, vps" style="width:100%; padding:8px 12px; background:var(--bg-elevated); border:1px solid var(--border); border-radius:8px; color:var(--text-primary); font-size:12.5px;">
                        </div>
                    </div>
